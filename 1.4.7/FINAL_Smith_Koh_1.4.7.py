...
def modify(directory = None):
    ...
    # Infite loop checking if the red value given is NONE or cannot be converted 
    # to an int
    while 1: 
    ...
    while rValue > 255: #Red value cannot be over 255
        ...
        try:
            ...
            print("That was not a number.")
    # Infite loop checking if the green value given is NONE or cannot be converted 
    # to an int
    while 1: 
    ...
    while gValue > 255:#Green value cannot be over 255
        ...
        try:
            ...
            print("That was not a number.")
    # Infite loop checking if the blue value given is NONE or cannot be converted 
    # to an int
    while 1:
    ...
    # If the border is not (0, 0, 0), ask for the thickness
    while border_color != (0, 0, 0): 
